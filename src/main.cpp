...
void loop(){
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (header.indexOf("GET /Forward") >= 0) {
              ...
              Serial.println("Stop");
              command = "Stop";
            } else if(header.indexOf("GET /Standclimb") >= 0){
              command = "Standclimb";
            } else if(header.indexOf("GET /climb") >= 0){
              command = "climb";
            } else if(header.indexOf("GET /standwalk") >= 0){
              command = "standwalk";
            }
            ...
            client.println("<p><a href=\"/Standclimb\"><button class=\"button\">StandClimb</button></a></p>");
            client.println("<p><a href=\"/climb\"><button class=\"button\">Climb</button></a></p>");
            client.println("<p><a href=\"/standwalk\"><button class=\"button\">StandWalk</button></a></p>");

            // Print distance
            client.print("<p>Distance in Cm: </p>");
            client.println("<p>" +String(distanceCm)+"</p>");
  ...
  if(command == "Forward"){
    ...
    TurnRight();
  }else if(command == "Standclimb"){
    standclimb();
  }else if(command == "climb"){
    climb();
  }else if(command == "standwalk"){
    standwalk();
  }
  if(j == 1){
    resetB();
